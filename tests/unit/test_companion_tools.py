...
def test_companion_tools_parse() -> None:
    tools_dir = Path("bundles/companion/tools")
...
def test_companion_bundle_yaml_valid() -> None:
    bundle_path = Path("bundles/companion/bundle.yaml")
