...
Current focus:
- Execute the v6 corrective implementation plan end-to-end with per-step commits.

Current status:
- v6 Step 1 complete: workspace-relative concise label qualification.
- v6 Step 2 complete: component scoring and core/peripheral zoning layout.
